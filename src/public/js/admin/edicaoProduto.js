...
const Edicao = {
    atualizar: async (id) => {
        ...
        for (let i = 0; i < formulariosVariantes.length; i++) {
            const variante = {
                variante_id: document.querySelectorAll('[name=variante_id]')[i].innerText,
...
const Variante = {
    ...
    adicionar: () => {
        ...
        <div name="variante" class="col-span-2  border shadow-lg p-5 bg-gray-50" >
